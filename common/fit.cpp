...
static void common_params_fit_impl(
        ...
        size_t * margins_s, uint32_t n_ctx_min, const common_fit_extra_model * extra,
        bool whole_layers, bool fill_rpc_first, bool cpu_moe,
...
enum common_params_fit_status common_fit_params(
    ...
    try {
        common_params_fit_impl(path_model, mparams, cparams, tensor_split, tensor_buft_overrides, margins, n_ctx_min, extra, whole_layers, fill_rpc_first, cpu_moe, log_level);
