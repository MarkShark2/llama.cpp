...
struct decode_embd_batch {
    ...
    // [fork] cycle a token-id palette over the image positions (DSV4 hash routing);
    // the phase is anchored at the start of the image so it is independent of how
    // the chunk is split into batches
